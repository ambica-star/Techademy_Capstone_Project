...
echo This will download the latest EdgeDriver compatible with your Edge version
echo ========================================
"%MAVEN_HOME%\bin\mvn.cmd" clean test -Dbrowser=edge
